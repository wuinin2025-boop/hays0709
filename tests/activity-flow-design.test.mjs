...
assert.match(html, /let posterAssetsReport;/);
assert.match(html, /let pendingPosterAssetsReport;/);
assert.match(html, /function ensurePosterAssets\(report\)/);
assert.match(html, /if \(posterAssetsReport === report \|\| pendingPosterAssetsReport === report\) return;/);
